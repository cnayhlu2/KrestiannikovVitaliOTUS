...
namespace Game.GameEngine.Mechanics
{
    ...
    public sealed class UTransformEngine : MonoBehaviour
    {
        ...
        [Space] [SerializeField] private Transform sourcePositionTransform;

        [SerializeField] private Transform[] movingTransforms;

        [Space] [SerializeField] private Transform sourceRotationTransform;

        [SerializeField] private Transform[] rotatingTransforms;
